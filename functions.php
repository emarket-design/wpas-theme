<?php
/**
 * Wpas functions and definitions
 *
 * @package Wpas
 * @since Wpas 1.0
 */
...
if ( ! function_exists( 'wpas_setup' ) ) {
	function wpas_setup() {
		 ...
		 * to change 'wpas' to the name of your theme in all the template files
		 */
		load_theme_textdomain( 'wpas', trailingslashit( get_template_directory() ) . 'languages' );
		...
		register_nav_menus( array(
				'primary' => esc_html__( 'Primary Menu', 'wpas' )
			) );
		...
		if( wpas_is_woocommerce_active() && !of_get_option( 'woocommerce_breadcrumbs', '1' ) ) {
			add_action( 'init', 'wpas_remove_woocommerce_breadcrumbs' );
		}
	}
}
add_action( 'after_setup_theme', 'wpas_setup' );
...
if ( ! function_exists( '_wp_render_title_tag' ) ) {
	function wpas_slug_render_title() { ?>
		<title><?php wp_title( '|', true, 'right' ); ?></title>
	<?php }
	add_action( 'wp_head', 'wpas_slug_render_title' );
}
...
function wpas_fonts_url() {
	 ...
	 */
	$pt_sans = _x( 'on', 'PT Sans font: on or off', 'wpas' );
	 ...
	 * Do not translate into your own language.
	 */
	$subset = _x( 'no-subset', 'PT Sans font: add new subset (cyrillic)', 'wpas' );
	 ...
	 * Do not translate into your own language.
	 */
	$arvo = _x( 'on', 'Arvo font: on or off', 'wpas' );
 ...
 */
function wpas_mce_css( $mce_css ) {
	$fonts_url = wpas_fonts_url();
...
add_filter( 'mce_css', 'wpas_mce_css' );
...
function wpas_widgets_init() {
	register_sidebar( array(
			'name' => esc_html__( 'Main Sidebar', 'wpas' ),
			'id' => 'sidebar-main',
			'description' => esc_html__( 'Appears in the sidebar on posts and pages except the optional Front Page template, which has its own widgets', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Blog Sidebar', 'wpas' ),
			'id' => 'sidebar-blog',
			'description' => esc_html__( 'Appears in the sidebar on the blog and archive pages only', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Single Post Sidebar', 'wpas' ),
			'id' => 'sidebar-single',
			'description' => esc_html__( 'Appears in the sidebar on single posts only', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Page Sidebar', 'wpas' ),
			'id' => 'sidebar-page',
			'description' => esc_html__( 'Appears in the sidebar on pages only', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Front Page Banner Widget', 'wpas' ),
			'id' => 'frontpage-banner1',
			'description' => esc_html__( 'Appears in the banner area on the Front Page', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Front Page Banner Widget', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Front Page Widget Area', 'wpas' ),
			'id' => 'sidebar-homepage1',
			'description' => esc_html__( 'Appears when using the optional Front Page template with a page set as Static Front Page', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Front Page Widget Area', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Third Front Page Widget Area', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'Fourth Front Page Widget Area', 'wpas' ),
	...
	register_sidebar( array(
			'name' => esc_html__( 'First Footer Widget Area', 'wpas' ),
			'id' => 'sidebar-footer1',
			'description' => esc_html__( 'Appears in the footer sidebar', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
			'before_title' => '<h3 class="widget-title">',
			'after_title' => '</h3>'
	...
	register_sidebar( array(
			'name' => esc_html__( 'Second Footer Widget Area', 'wpas' ),
			'id' => 'sidebar-footer2',
			'description' => esc_html__( 'Appears in the footer sidebar', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
	...
	register_sidebar( array(
			'name' => esc_html__( 'Third Footer Widget Area', 'wpas' ),
			'id' => 'sidebar-footer3',
			'description' => esc_html__( 'Appears in the footer sidebar', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
	...
	register_sidebar( array(
			'name' => esc_html__( 'Fourth Footer Widget Area', 'wpas' ),
			'id' => 'sidebar-footer4',
			'description' => esc_html__( 'Appears in the footer sidebar', 'wpas' ),
			'before_widget' => '<aside id="%1$s" class="widget %2$s">',
			'after_widget' => '</aside>',
...
add_action( 'widgets_init', 'wpas_widgets_init' );
...
function wpas_scripts_styles() {
	...
	wp_register_style( 'font-awesome', trailingslashit( get_template_directory_uri() ) . 'css/font-awesome.min.css' , array( 'normalize' ), '4.2.0', 'all' );
	 ...
	 *     wp_dequeue_style( 'wpas-fonts' );
	 * }
	 * add_action( 'wp_enqueue_scripts', 'mytheme_dequeue_fonts', 11 );
	 */
	$fonts_url = wpas_fonts_url();
	if ( !empty( $fonts_url ) ) {
		wp_enqueue_style( 'wpas-fonts', esc_url_raw( $fonts_url ), array(), null );
	}
	...
	if ( is_singular() && comments_open() ) {
		...
		wp_localize_script( 'commentvalidate', 'comments_object', array(
			...
			'author'  => esc_html__( 'Please enter your name', 'wpas' ),
			'email'  => esc_html__( 'Please enter a valid email address', 'wpas' ),
			'comment' => esc_html__( 'Please add a comment', 'wpas' ) )
		);
	}
...
add_action( 'wp_enqueue_scripts', 'wpas_scripts_styles' );
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_content_nav' ) ) {
	function wpas_content_nav( $nav_id ) {
		global $wp_query;
 ...
 * simply create your own wpas_comment(), and that function will be used instead.
 *
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_comment' ) ) {
	function wpas_comment( $comment, $args, $depth ) {
		...
		case 'trackback' :
			...
			<li <?php comment_class(); ?> id="comment-<?php comment_ID(); ?>">
				<article id="comment-<?php comment_ID(); ?>" class="pingback">
					<p><?php esc_html_e( 'Pingback:', 'wpas' ); ?> <?php comment_author_link(); ?> <?php edit_comment_link( esc_html__( '(Edit)', 'wpas' ), '<span class="edit-link">', '</span>' ); ?></p>
				...
				<article id="comment-<?php comment_ID(); ?>" class="comment">
					<header class="comment-meta comment-author vcard">
						...
						printf( '<cite class="fn">%1$s %2$s</cite>',
							...
							( $comment->user_id === $post->post_author ) ? '<span> ' . esc_html__( 'Post author', 'wpas' ) . '</span>' : '' );
						printf( '<a href="%1$s" title="Posted %2$s"><time itemprop="datePublished" datetime="%3$s">%4$s</time></a>',
							esc_url( get_comment_link( $comment->comment_ID ) ),
							sprintf( esc_html__( '%1$s @ %2$s', 'wpas' ), esc_html( get_comment_date() ), esc_attr( get_comment_time() ) ),
							get_comment_time( 'c' ),
							/* Translators: 1: date, 2: time */
							sprintf( esc_html__( '%1$s at %2$s', 'wpas' ), get_comment_date(), get_comment_time() )
						);
						?>
					</header> <!-- .comment-meta -->

					<?php if ( '0' == $comment->comment_approved ) { ?>
						<p class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'wpas' ); ?></p>
					<?php } ?>

					<section class="comment-content comment">
						<?php comment_text(); ?>
						<?php edit_comment_link( esc_html__( 'Edit', 'wpas' ), '<p class="edit-link">', '</p>' ); ?>
					</section> <!-- .comment-content -->

					<div class="reply">
						<?php comment_reply_link( array_merge( $args, array( 'reply_text' => wp_kses( __( 'Reply <span>&darr;</span>', 'wpas' ), array( 'span' => array() ) ), 'depth' => $depth, 'max_depth' => $args['max_depth'] ) ) ); ?>
					</div> <!-- .reply -->
				</article> <!-- #comment-## -->
			<?php
			break;
 ...
 */
function wpas_comment_form_default_fields( $fields ) {

	$commenter = wp_get_current_commenter();
	$req = get_option( 'require_name_email' );
	$aria_req = ( $req ? ' aria-required="true"' : "" );

	$fields[ 'author' ] = '<p class="comment-form-author">' . '<label for="author">' . esc_html__( 'Name', 'wpas' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' . '<input id="author" name="author" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '" size="30"' . $aria_req . ' /></p>';

	$fields[ 'email' ] =  '<p class="comment-form-email"><label for="email">' . esc_html__( 'Email', 'wpas' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' . '<input id="email" name="email" type="text" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30"' . $aria_req . ' /></p>';

	$fields[ 'url' ] =  '<p class="comment-form-url"><label for="url">' . esc_html__( 'Website', 'wpas' ) . '</label>' . '<input id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" /></p>';

	return $fields;

}
add_action( 'comment_form_default_fields', 'wpas_comment_form_default_fields' );
 ...
 */
function wpas_comment_form_field_comment( $field ) {

	$field = '<p class="comment-form-comment"><label for="comment">' . _x( 'Comment', 'noun', 'wpas' ) . ' <span class="required">*</span></label><textarea id="comment" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>';

	return $field;

}
add_action( 'comment_form_field_comment', 'wpas_comment_form_field_comment' );
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_posted_on' ) ) {
	function wpas_posted_on() {
		$post_icon = '';
		...
		$date = sprintf( '<i class="fa %1$s"></i> <a href="%2$s" title="Posted %3$s" rel="bookmark"><time class="entry-date" datetime="%4$s" itemprop="datePublished">%5$s</time></a>',
			...
			sprintf( esc_html__( '%1$s @ %2$s', 'wpas' ), esc_html( get_the_date() ), esc_attr( get_the_time() ) ),
		...
		$categories_list = get_the_category_list( esc_html__( ' ', 'wpas' ) );
		...
		$comments = sprintf( '<span class="comments-link"><i class="fa fa-comment"></i> <a href="%1$s" title="%2$s">%3$s</a></span>',
			...
			( get_comments_number() > 0 ? sprintf( _n( '%1$s Comment', '%1$s Comments', get_comments_number(), 'wpas' ), get_comments_number() ) : esc_html__( 'No Comments', 'wpas' ) )
		);

		// Translators: 1: Date 2: Author 3: Categories 4: Comments
		printf( wp_kses( __( '<div class="header-meta">%1$s%2$s<span class="post-categories">%3$s</span>%4$s</div>', 'wpas' ), array( 
			'div' => array ( 
				'class' => array() ), 
			'span' => array( 
				'class' => array() ) ) ),
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_entry_meta' ) ) {
	function wpas_entry_meta() {
		// Return the Tags as a list
		$tag_list = "";
		if ( get_the_tag_list() ) {
			$tag_list = get_the_tag_list( '<span class="post-tags">', esc_html__( ' ', 'wpas' ), '</span>' );
		}

		// Translators: 1 is tag
		if ( $tag_list ) {
			printf( wp_kses( __( '<i class="fa fa-tag"></i> %1$s', 'wpas' ), array( 'i' => array( 'class' => array() ) ) ), $tag_list );
		}
	}
}
 ...
 * @return void
 */
function wpas_content_width() {
	if ( is_page_template( 'page-templates/full-width.php' ) || is_attachment() ) {
		global $content_width;
		$content_width = 1200;
	}
}
add_action( 'template_redirect', 'wpas_content_width' );
 ...
 */
function wpas_remove_more_jump_link( $link ) {
...
add_filter( 'the_content_more_link', 'wpas_remove_more_jump_link' );
 ...
 */
function wpas_continue_reading_link() {
	return '&hellip;<p><a class="more-link" href="'. esc_url( get_permalink() ) . '" title="' . esc_html__( 'Continue reading', 'wpas' ) . ' &lsquo;' . get_the_title() . '&rsquo;">' . wp_kses( __( 'Continue reading <span class="meta-nav">&rarr;</span>', 'wpas' ), array( 'span' => array( 
			'class' => array() ) ) ) . '</a></p>';
}


/**
 * Replaces "[...]" (appended to automatically generated excerpts) with the wpas_continue_reading_link().
 *
 * @since Wpas 1.0
 *
 ...
 */
function wpas_auto_excerpt_more( $more ) {
	return wpas_continue_reading_link();
}
add_filter( 'excerpt_more', 'wpas_auto_excerpt_more' );
 ...
 */
function wpas_new_contactmethods( $contactmethods ) {
	// Add Twitter
...
add_filter( 'user_contactmethods', 'wpas_new_contactmethods', 10, 1 );
 ...
 */
function wpas_add_menu_parent_class( $items ) {
...
add_filter( 'wp_nav_menu_objects', 'wpas_add_menu_parent_class' );
 ...
 */
if ( ! function_exists( 'wpas_get_social_media' ) ) {
	function wpas_get_social_media() {
		$output = '';
		$icons = array(
			array( 'url' => of_get_option( 'social_twitter', '' ), 'icon' => 'fa-twitter', 'title' => esc_html__( 'Follow me on Twitter', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_facebook', '' ), 'icon' => 'fa-facebook', 'title' => esc_html__( 'Friend me on Facebook', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_googleplus', '' ), 'icon' => 'fa-google-plus', 'title' => esc_html__( 'Connect with me on Google+', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_linkedin', '' ), 'icon' => 'fa-linkedin', 'title' => esc_html__( 'Connect with me on LinkedIn', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_slideshare', '' ), 'icon' => 'fa-slideshare', 'title' => esc_html__( 'Follow me on SlideShare', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_dribbble', '' ), 'icon' => 'fa-dribbble', 'title' => esc_html__( 'Follow me on Dribbble', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_tumblr', '' ), 'icon' => 'fa-tumblr', 'title' => esc_html__( 'Follow me on Tumblr', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_github', '' ), 'icon' => 'fa-github', 'title' => esc_html__( 'Fork me on GitHub', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_bitbucket', '' ), 'icon' => 'fa-bitbucket', 'title' => esc_html__( 'Fork me on Bitbucket', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_foursquare', '' ), 'icon' => 'fa-foursquare', 'title' => esc_html__( 'Follow me on Foursquare', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_youtube', '' ), 'icon' => 'fa-youtube', 'title' => esc_html__( 'Subscribe to me on YouTube', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_instagram', '' ), 'icon' => 'fa-instagram', 'title' => esc_html__( 'Follow me on Instagram', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_flickr', '' ), 'icon' => 'fa-flickr', 'title' => esc_html__( 'Connect with me on Flickr', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_pinterest', '' ), 'icon' => 'fa-pinterest', 'title' => esc_html__( 'Follow me on Pinterest', 'wpas' ) ),
			array( 'url' => of_get_option( 'social_rss', '' ), 'icon' => 'fa-rss', 'title' => esc_html__( 'Subscribe to my RSS Feed', 'wpas' ) )
		);
 ...
 */
if ( ! function_exists( 'wpas_get_credits' ) ) {
	function wpas_get_credits() {
		$output = '';
		$output = sprintf( '%1$s <a href="%2$s" title="%3$s">%4$s</a>',
			esc_html__( 'Proudly powered by', 'wpas' ),
			esc_url( esc_html__( 'http://wordpress.org/', 'wpas' ) ),
			esc_attr( esc_html__( 'Semantic Personal Publishing Platform', 'wpas' ) ),
			esc_html__( 'WordPress', 'wpas' )
		);
 ...
 * @return void
 */
function wpas_theme_options_styles() {
	$output = '';
...
add_action( 'wp_head', 'wpas_theme_options_styles' );
 ...
 * @return void
 */
function wpas_is_woocommerce_active() {
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_setup_woocommerce_wrappers' ) ) {
	function wpas_setup_woocommerce_wrappers() {
		if ( wpas_is_woocommerce_active() && is_woocommerce() ) {
				add_action( 'wpas_before_woocommerce', 'wpas_before_woocommerce_wrapper', 10, 0 );
				add_action( 'wpas_after_woocommerce', 'wpas_after_woocommerce_wrapper', 10, 0 );		
		}
	}
	add_action( 'template_redirect', 'wpas_setup_woocommerce_wrappers', 9 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_woocommerce_before_main_content' ) ) {
	function wpas_woocommerce_before_main_content() {
	...
	add_action( 'woocommerce_before_main_content', 'wpas_woocommerce_before_main_content', 10 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_woocommerce_after_main_content' ) ) {
	function wpas_woocommerce_after_main_content() {
		echo '</div>';
	}
	add_action( 'woocommerce_after_main_content', 'wpas_woocommerce_after_main_content', 10 );
}
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_remove_woocommerce_sidebar' ) ) {
	function wpas_remove_woocommerce_sidebar() {
		if( ( is_shop() && !of_get_option( 'woocommerce_shopsidebar', '1' ) ) || ( is_product() && !of_get_option( 'woocommerce_productsidebar', '1' ) ) ) {
			remove_action( 'woocommerce_sidebar', 'woocommerce_get_sidebar', 10 );
		}
	}
	add_action( 'woocommerce_before_main_content', 'wpas_remove_woocommerce_sidebar' );
}
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_remove_woocommerce_breadcrumbs' ) ) {
	function wpas_remove_woocommerce_breadcrumbs() {
 ...
 * @return void
 */
if ( ! function_exists( 'wpas_set_number_woocommerce_products' ) ) {
	function wpas_set_number_woocommerce_products() {
	...
	add_action( 'init', 'wpas_set_number_woocommerce_products' );
}
