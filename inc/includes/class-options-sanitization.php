...
function of_recognized_background_repeat() {
	$default = array(
		...
		'repeat'    => esc_html__( 'Repeat All', 'wpas' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'wpas' ),
		'top center'    => esc_html__( 'Top Center', 'wpas' ),
		'top right'     => esc_html__( 'Top Right', 'wpas' ),
		'center left'   => esc_html__( 'Middle Left', 'wpas' ),
		'center center' => esc_html__( 'Middle Center', 'wpas' ),
		'center right'  => esc_html__( 'Middle Right', 'wpas' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'wpas' ),
		'bottom center' => esc_html__( 'Bottom Center', 'wpas' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'wpas')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'wpas' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'wpas')
		);
...
function of_recognized_font_styles() {
	$default = array(
		...
		'italic'      => esc_html__( 'Italic', 'wpas' ),
		'bold'        => esc_html__( 'Bold', 'wpas' ),
		'bold italic' => esc_html__( 'Bold Italic', 'wpas' )
		);
